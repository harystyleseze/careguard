...
export function PolicyTab({
  ...
  return (
    <div
      ...
      tabIndex={0}
      className="w-full max-w-none rounded-xl border border-slate-200 bg-white p-4 sm:max-w-lg sm:p-6"
    >
      ...
      >
          ...
          return (
            <div key={key}>
              ...
              <input
                ...
                className={`w-full min-h-11 px-3 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 ${
                  errMsg
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <button
            type="button"
            onClick={onForceSync}
            className="w-full rounded-lg bg-slate-100 px-4 py-3 text-sm font-medium text-slate-700 transition-all cursor-pointer hover:bg-slate-200 active:bg-slate-300 sm:flex-1"
          >
            Refresh from server
          </button>
          <button
        ...
        <button
          ...
          className={`w-full min-h-11 rounded-lg px-4 py-3 text-sm font-medium transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${
            policySaved
